...
class FeesEstimateRequest(object):
    ...
    def __init__(self, marketplace_id=None, is_amazon_fulfilled=None, price_to_estimate_fees=None, identifier=None, optional_fulfillment_program=None):  # noqa: E501
    ...
    def price_to_estimate_fees(self):
        ...
        The product price that the fee estimate is based on.  # noqa: E501
