...
class GetMyFeesEstimatesErrorList(object):
    ...
    def __init__(self, errors=None):  # noqa: E501
        """GetMyFeesEstimatesErrorList - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GetMyFeesEstimatesErrorList, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetMyFeesEstimatesErrorList):
            return False
