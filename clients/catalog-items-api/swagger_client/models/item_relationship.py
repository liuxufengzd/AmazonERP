...
class ItemRelationship(object):
    ...
    def variation_theme(self):
        ...
        For `VARIATION` relationships, the variation theme indicates the combination of Amazon catalog item attributes that define the variation family.  # noqa: E501
