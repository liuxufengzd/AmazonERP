...
class Transaction(object):
    ...
    def __init__(self, transaction_id=None, status=None, errors=None):  # noqa: E501
    ...
    def transaction_id(self):
        ...
        The unique identifier sent in the 'transactionId' field in response to the post request of a specific transaction.  # noqa: E501
    ...
    def errors(self):
        ...
        Error code and message for the failed transaction. Only available when transaction status is 'Failure'.  # noqa: E501
