...
class ItemPromotion(object):
    ...
    """
    swagger_types = {
        'breakdowns': 'list[ItemPromotionBreakdown]'
    }
    ...
    def __init__(self, breakdowns=None):  # noqa: E501
    ...
    @property
    def breakdowns(self):
        """Gets the breakdowns of this ItemPromotion.  # noqa: E501

        A list of promotions applied to the order item.  # noqa: E501

        :return: The breakdowns of this ItemPromotion.  # noqa: E501
        :rtype: list[ItemPromotionBreakdown]
        """
        return self._breakdowns

    @breakdowns.setter
    def breakdowns(self, breakdowns):
        """Sets the breakdowns of this ItemPromotion.

        A list of promotions applied to the order item.  # noqa: E501

        :param breakdowns: The breakdowns of this ItemPromotion.  # noqa: E501
        :type: list[ItemPromotionBreakdown]
        """
