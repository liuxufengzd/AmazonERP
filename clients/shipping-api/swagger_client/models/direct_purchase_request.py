...
class DirectPurchaseRequest(object):
    ...
    def ship_to(self):
        ...
        The address where the shipment will be delivered. For vendor orders, shipTo information is pulled directly from the Amazon order.  # noqa: E501
    ...
    def ship_from(self):
        ...
        The address where the package will be picked up.  # noqa: E501
    ...
    def return_to(self):
        ...
        The address where the package will be returned if it cannot be delivered.  # noqa: E501
    ...
    def label_specifications(self):
        ...
        The document (label) specifications requested. The default label returned is PNG DPI 203 4x6 if no label specification is provided. Requesting an invalid file format results in a failure.  # noqa: E501
