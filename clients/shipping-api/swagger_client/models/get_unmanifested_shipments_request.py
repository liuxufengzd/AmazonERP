...
class GetUnmanifestedShipmentsRequest(object):
    ...
    def __init__(self, client_reference_details=None):  # noqa: E501
        """GetUnmanifestedShipmentsRequest - a model defined in Swagger"""  # noqa: E501
    ...
    def client_reference_details(self):
        """Gets the client_reference_details of this GetUnmanifestedShipmentsRequest.  # noqa: E501


        :return: The client_reference_details of this GetUnmanifestedShipmentsRequest.  # noqa: E501
    ...
    def client_reference_details(self, client_reference_details):
        """Sets the client_reference_details of this GetUnmanifestedShipmentsRequest.


        :param client_reference_details: The client_reference_details of this GetUnmanifestedShipmentsRequest.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GetUnmanifestedShipmentsRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetUnmanifestedShipmentsRequest):
            return False
