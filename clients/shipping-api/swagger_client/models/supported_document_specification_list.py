...
class SupportedDocumentSpecificationList(object):
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SupportedDocumentSpecificationList, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SupportedDocumentSpecificationList):
            return False
