...
class Currency(object):
    ...
    def unit(self, unit):
        ...
        if unit is not None and len(unit) > 3:
            raise ValueError("Invalid value for `unit`, length must be less than or equal to `3`")  # noqa: E501
        if unit is not None and len(unit) < 3:
            raise ValueError("Invalid value for `unit`, length must be greater than or equal to `3`")  # noqa: E501
