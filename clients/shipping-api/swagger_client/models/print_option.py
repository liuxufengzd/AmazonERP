...
class PrintOption(object):
    ...
    def __init__(self, supported_dp_is=None, supported_page_layouts=None, supported_file_joining_options=None, supported_document_details=None):  # noqa: E501
        """PrintOption - a model defined in Swagger"""  # noqa: E501

        self._supported_dp_is = None
        self._supported_page_layouts = None
        self._supported_file_joining_options = None
        self._supported_document_details = None
        self.discriminator = None

        if supported_dp_is is not None:
            self.supported_dp_is = supported_dp_is
    ...
    @property
    def supported_dp_is(self):
        """Gets the supported_dp_is of this PrintOption.  # noqa: E501

        A list of the supported DPI options for a document.  # noqa: E501

        :return: The supported_dp_is of this PrintOption.  # noqa: E501
        :rtype: list[Dpi]
        """
        return self._supported_dp_is

    @supported_dp_is.setter
    def supported_dp_is(self, supported_dp_is):
        """Sets the supported_dp_is of this PrintOption.

        A list of the supported DPI options for a document.  # noqa: E501

        :param supported_dp_is: The supported_dp_is of this PrintOption.  # noqa: E501
        :type: list[Dpi]
        """

        self._supported_dp_is = supported_dp_is
