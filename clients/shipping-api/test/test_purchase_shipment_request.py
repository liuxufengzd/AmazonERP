...
from swagger_client.models.purchase_shipment_request import PurchaseShipmentRequest  # noqa: E501
...
class TestPurchaseShipmentRequest(unittest.TestCase):
    ...
    def testPurchaseShipmentRequest(self):
        ...
        # model = swagger_client.models.purchase_shipment_request.PurchaseShipmentRequest()  # noqa: E501
        pass
