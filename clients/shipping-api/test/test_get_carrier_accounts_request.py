...
from swagger_client.models.get_carrier_accounts_request import GetCarrierAccountsRequest  # noqa: E501
...
class TestGetCarrierAccountsRequest(unittest.TestCase):
    ...
    def testGetCarrierAccountsRequest(self):
        ...
        # model = swagger_client.models.get_carrier_accounts_request.GetCarrierAccountsRequest()  # noqa: E501
        pass
