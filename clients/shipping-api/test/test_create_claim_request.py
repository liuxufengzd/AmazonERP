...
from swagger_client.models.create_claim_request import CreateClaimRequest  # noqa: E501
...
class TestCreateClaimRequest(unittest.TestCase):
    ...
    def testCreateClaimRequest(self):
        ...
        # model = swagger_client.models.create_claim_request.CreateClaimRequest()  # noqa: E501
        pass
