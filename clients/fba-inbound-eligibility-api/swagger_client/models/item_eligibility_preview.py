...
class ItemEligibilityPreview(object):
    ...
    def __init__(self, asin=None, marketplace_id=None, program=None, is_eligible_for_program=None, ineligibility_reason_list=None):  # noqa: E501
    ...
    def is_eligible_for_program(self, is_eligible_for_program):
        ...
        :type: bool
        """
        if is_eligible_for_program is None:
    ...
    def ineligibility_reason_list(self, ineligibility_reason_list):
        ...
        if not set(ineligibility_reason_list).issubset(set(allowed_values)):
            raise ValueError(
