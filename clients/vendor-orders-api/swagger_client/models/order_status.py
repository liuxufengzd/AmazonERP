...
class OrderStatus(object):
    ...
    def __init__(self, purchase_order_number=None, purchase_order_status=None, purchase_order_date=None, last_updated_date=None, selling_party=None, ship_to_party=None, item_status=None):  # noqa: E501
    ...
    def purchase_order_status(self, purchase_order_status):
        ...
        if purchase_order_status not in allowed_values:
            raise ValueError(
    ...
    def item_status(self):
        ...
        Detailed order status.  # noqa: E501
