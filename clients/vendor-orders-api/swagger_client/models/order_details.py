...
class OrderDetails(object):
    ...
    def __init__(self, purchase_order_date=None, purchase_order_changed_date=None, purchase_order_state_changed_date=None, purchase_order_type=None, import_details=None, deal_code=None, payment_method=None, buying_party=None, selling_party=None, ship_to_party=None, bill_to_party=None, ship_window=None, delivery_window=None, items=None):  # noqa: E501
    ...
    def purchase_order_date(self, purchase_order_date):
        ...
        :type: datetime
        """
        if purchase_order_date is None:
    ...
    def purchase_order_state_changed_date(self, purchase_order_state_changed_date):
        ...
        :type: datetime
        """
        if purchase_order_state_changed_date is None:
    ...
    def purchase_order_type(self, purchase_order_type):
        ...
        if purchase_order_type not in allowed_values:
            raise ValueError(
    ...
    def import_details(self):
        ...
        If the purchase order is an import order, the details for the import order.  # noqa: E501
    ...
    def buying_party(self):
        ...
        Name/Address and tax details of the buying party.  # noqa: E501
    ...
    def selling_party(self):
        ...
        Name/Address and tax details of the selling party.  # noqa: E501
    ...
    def ship_to_party(self):
        ...
        Name/Address and tax details of the ship to party. Find a list of fulfillment center addresses for a region on the [Resources page of Amazon Vendor Central](https://vendorcentral.amazon.com/hz/vendor/members/support/help/node/GPZ88XH8HQM97ZV6).  # noqa: E501
    ...
    def ship_window(self):
        ...
        This indicates the ship window. Format is start and end date separated by double hyphen (--). For example, 2007-03-01T13:00:00Z--2007-03-11T15:30:00Z.  # noqa: E501
    ...
    def delivery_window(self):
        ...
        This indicates the delivery window. Format is start and end date separated by double hyphen (--). For example, 2007-03-01T13:00:00Z--2007-03-11T15:30:00Z.  # noqa: E501
