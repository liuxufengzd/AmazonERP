...
class OrderAcknowledgementItem(object):
    ...
    def __init__(self, item_sequence_number=None, amazon_product_identifier=None, vendor_product_identifier=None, ordered_quantity=None, net_cost=None, list_price=None, discount_multiplier=None, item_acknowledgements=None):  # noqa: E501
    ...
    def ordered_quantity(self):
        ...
        The quantity of this item ordered.  # noqa: E501
    ...
    def net_cost(self):
        ...
        The net cost of an item per each or weight unit that must match the cost on the invoice. This is a required field. If left blank, Amazon systems will reject the file. Price information must not be zero or negative.  # noqa: E501
    ...
    def list_price(self):
        ...
        The list price of an item per each or weight unit. Required only if a vendor sells books at list price.  # noqa: E501
    ...
    def item_acknowledgements(self, item_acknowledgements):
        ...
        """
        if item_acknowledgements is None:
