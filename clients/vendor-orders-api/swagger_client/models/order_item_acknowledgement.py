...
class OrderItemAcknowledgement(object):
    ...
    def __init__(self, acknowledgement_code=None, acknowledged_quantity=None, scheduled_ship_date=None, scheduled_delivery_date=None, rejection_reason=None):  # noqa: E501
    ...
    def acknowledgement_code(self, acknowledgement_code):
        ...
        :type: str
        """
        if acknowledgement_code is None:
        ...
        if acknowledgement_code not in allowed_values:
            raise ValueError(
    ...
    def acknowledged_quantity(self):
        ...
        Details of quantity acknowledged with the above acknowledgement code.  # noqa: E501
    ...
    def acknowledged_quantity(self, acknowledged_quantity):
        ...
        :type: ItemQuantity
        """
        if acknowledged_quantity is None:
