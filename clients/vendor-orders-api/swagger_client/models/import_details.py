...
class ImportDetails(object):
    ...
    def __init__(self, method_of_payment=None, international_commercial_terms=None, port_of_delivery=None, import_containers=None, shipping_instructions=None):  # noqa: E501
    ...
    def international_commercial_terms(self, international_commercial_terms):
        ...
        if international_commercial_terms not in allowed_values:
            raise ValueError(
    ...
    def port_of_delivery(self, port_of_delivery):
        ...
        :type: str
        """
        if port_of_delivery is not None and len(port_of_delivery) > 64:
