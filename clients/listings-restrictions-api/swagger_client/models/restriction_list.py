...
class RestrictionList(object):
    ...
    def __init__(self, restrictions=None):  # noqa: E501
        """RestrictionList - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RestrictionList, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RestrictionList):
            return False
