...
class Invoice(object):
    ...
    def __init__(self, _date=None, error_code=None, external_invoice_id=None, gov_response=None, id=None, invoice_type=None, series=None, status=None, transaction_ids=None, transaction_type=None):  # noqa: E501
