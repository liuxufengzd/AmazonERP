...
class Export(object):
    ...
    def __init__(self, error_message=None, export_id=None, generate_export_finished_at=None, generate_export_started_at=None, invoices_document_ids=None, status=None):  # noqa: E501
