...
class InvoiceDocument(object):
    ...
    def __init__(self, invoice_document_url=None):  # noqa: E501
        """InvoiceDocument - a model defined in Swagger"""  # noqa: E501

        self._invoice_document_url = None
        self.discriminator = None

        if invoice_document_url is not None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(InvoiceDocument, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InvoiceDocument):
            return False
