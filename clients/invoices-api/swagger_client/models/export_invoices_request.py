...
class ExportInvoicesRequest(object):
    ...
    def __init__(self, date_end=None, date_start=None, external_invoice_id=None, file_format=None, invoice_type=None, marketplace_id=None, series=None, statuses=None, transaction_identifier=None, transaction_type=None):  # noqa: E501
