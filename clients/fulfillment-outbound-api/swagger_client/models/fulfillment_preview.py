...
class FulfillmentPreview(object):
    ...
    def estimated_shipping_weight(self):
        ...
        Estimated shipping weight for this fulfillment order preview.  # noqa: E501
    ...
    def estimated_fees(self):
        ...
        The estimated fulfillment fees for this fulfillment order preview, if applicable. The fees data will not be available for IN marketplace orders.  # noqa: E501
    ...
    def fulfillment_preview_shipments(self):
        ...
        :rtype: FulfillmentPreviewShipmentList
        """
    ...
    def unfulfillable_preview_items(self):
        ...
        :rtype: UnfulfillablePreviewItemList
        """
    ...
    def order_unfulfillable_reasons(self):
        ...
        Error codes associated with the fulfillment order preview that indicate why the order is not fulfillable.  Error code examples:  `DeliverySLAUnavailable` `InvalidDestinationAddress`  # noqa: E501
