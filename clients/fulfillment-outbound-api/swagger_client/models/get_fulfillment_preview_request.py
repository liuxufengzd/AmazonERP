...
class GetFulfillmentPreviewRequest(object):
    ...
    def __init__(self, marketplace_id=None, address=None, items=None, shipping_speed_categories=None, include_cod_fulfillment_preview=None, include_delivery_windows=None, feature_constraints=None):  # noqa: E501
    ...
    def address(self):
        ...
        The destination address for the fulfillment order preview.  # noqa: E501
    ...
    def items(self):
        ...
        Identifying information and quantity information for the items in the fulfillment order preview. Maximum of 100 line items with a maximum of 250 units per order.   # noqa: E501

        :return: The items of this GetFulfillmentPreviewRequest.  # noqa: E501
        :rtype: GetFulfillmentPreviewItemList
        """
        return self._items
