...
class FulfillmentShipmentItem(object):
    ...
    swagger_types = {
        ...
        'package_number': 'int',
        'serial_number': 'str',
        'manufacturer_lot_codes': 'StringList'
    }
    ...
    def __init__(self, seller_sku=None, seller_fulfillment_order_item_id=None, quantity=None, package_number=None, serial_number=None, manufacturer_lot_codes=None):  # noqa: E501
    ...
    def manufacturer_lot_codes(self):
        ...
        The manufacturer lot codes of the shipped items.  # noqa: E501
