...
class CreateFulfillmentOrderRequest(object):
    ...
    def seller_fulfillment_order_id(self, seller_fulfillment_order_id):
        ...
        :type: str
        """
        if seller_fulfillment_order_id is None:
            raise ValueError("Invalid value for `seller_fulfillment_order_id`, must not be `None`")  # noqa: E501
        if seller_fulfillment_order_id is not None and len(seller_fulfillment_order_id) > 40:
    ...
    def displayable_order_id(self, displayable_order_id):
        ...
        :type: str
        """
        if displayable_order_id is None:
            raise ValueError("Invalid value for `displayable_order_id`, must not be `None`")  # noqa: E501
        if displayable_order_id is not None and len(displayable_order_id) > 40:
    ...
    def displayable_order_date(self):
        ...
        The date and time of the fulfillment order. Displays as the order date in recipient-facing materials such as the outbound shipment packing slip.  # noqa: E501
    ...
    def displayable_order_date(self, displayable_order_date):
        ...
        :type: Timestamp
        """
        if displayable_order_date is None:
    ...
    def displayable_order_comment(self, displayable_order_comment):
        ...
        :type: str
        """
        if displayable_order_comment is None:
            raise ValueError("Invalid value for `displayable_order_comment`, must not be `None`")  # noqa: E501
        if displayable_order_comment is not None and len(displayable_order_comment) > 750:
    ...
    def shipping_speed_category(self, shipping_speed_category):
        ...
        """
        if shipping_speed_category is None:
    ...
    def destination_address(self):
        ...
        The destination address for the fulfillment order.  # noqa: E501
    ...
    def items(self):
        ...
        A list of items to include in the fulfillment order preview, including quantity. Maximum of 100 line items with a maximum of 250 units per order.  # noqa: E501

        :return: The items of this CreateFulfillmentOrderRequest.  # noqa: E501
        :rtype: CreateFulfillmentOrderItemList
        """
        return self._items
    ...
    def payment_information(self):
        ...
        An array of various payment attributes related to this fulfillment order. This property is required if the order is placed against the India marketplace.  # noqa: E501
