...
class FulfillmentOrderItem(object):
    ...
    def cancelled_quantity(self):
        ...
        The item quantity that was cancelled by the seller.  # noqa: E501
    ...
    def unfulfillable_quantity(self):
        ...
        The item quantity that is unfulfillable.  # noqa: E501
    ...
    def unfulfillable_quantity(self, unfulfillable_quantity):
        ...
        :type: Quantity
        """
        if unfulfillable_quantity is None:
    ...
    def estimated_ship_date(self):
        ...
        The estimated date and time that the item quantity is scheduled to ship from the fulfillment center. Note that this value can change over time. If the shipment that contains the item quantity is cancelled, `estimatedShipDate` is not returned.  # noqa: E501
    ...
    def estimated_arrival_date(self):
        ...
        The estimated arrival date and time of the item quantity. Note that this value can change over time. If the shipment that contains the item quantity is cancelled, `estimatedArrivalDate` is not returned.  # noqa: E501
    ...
    def per_unit_price(self):
        ...
        The amount to be collected from the recipient for this item in a COD (Cash On Delivery) order.  # noqa: E501
    ...
    def per_unit_tax(self):
        ...
        The tax on the amount to be collected from the recipient for this item in a COD (Cash On Delivery) order.  # noqa: E501
    ...
    def per_unit_declared_value(self):
        ...
        The monetary value assigned by the seller to this item. This is a required field for India MCF orders.  # noqa: E501
