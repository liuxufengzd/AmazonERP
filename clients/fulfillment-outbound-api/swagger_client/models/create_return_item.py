...
class CreateReturnItem(object):
    ...
    def __init__(self, seller_return_item_id=None, seller_fulfillment_order_item_id=None, amazon_shipment_id=None, return_reason_code=None, return_comment=None):  # noqa: E501
    ...
    def seller_return_item_id(self, seller_return_item_id):
        ...
        :type: str
        """
        if seller_return_item_id is None:
            raise ValueError("Invalid value for `seller_return_item_id`, must not be `None`")  # noqa: E501
        if seller_return_item_id is not None and len(seller_return_item_id) > 80:
    ...
    def return_comment(self, return_comment):
        ...
        :type: str
        """
        if return_comment is not None and len(return_comment) > 1000:
