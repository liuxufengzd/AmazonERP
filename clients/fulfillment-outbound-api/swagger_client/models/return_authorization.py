...
class ReturnAuthorization(object):
    ...
    def __init__(self, return_authorization_id=None, fulfillment_center_id=None, return_to_address=None, amazon_rma_id=None, rma_page_url=None):  # noqa: E501
    ...
    def return_authorization_id(self, return_authorization_id):
        ...
        :type: str
        """
        if return_authorization_id is None:
    ...
    def return_to_address(self):
        ...
        The address of the Amazon fulfillment center that the return items should be sent to.  # noqa: E501
