...
class ProductTypeDefinition(object):
    ...
    def __init__(self, meta_schema=None, schema=None, requirements=None, requirements_enforced=None, property_groups=None, locale=None, marketplace_ids=None, product_type=None, display_name=None, product_type_version=None):  # noqa: E501
    ...
    def meta_schema(self):
        ...
        Link to meta-schema describing the vocabulary used by the product type schema.  # noqa: E501
    ...
    @property
    def schema(self):
        """Gets the schema of this ProductTypeDefinition.  # noqa: E501

        Link to schema describing the attributes and requirements for the product type.  # noqa: E501

        :return: The schema of this ProductTypeDefinition.  # noqa: E501
        :rtype: SchemaLink
        """
        return self._schema
    ...
    def schema(self, schema):
        """Sets the schema of this ProductTypeDefinition.

        Link to schema describing the attributes and requirements for the product type.  # noqa: E501

        :param schema: The schema of this ProductTypeDefinition.  # noqa: E501
        :type: SchemaLink
        """
        if schema is None:
    ...
    def requirements(self, requirements):
        ...
        if requirements not in allowed_values:
            raise ValueError(
    ...
    def requirements_enforced(self, requirements_enforced):
        ...
        :type: str
        """
        if requirements_enforced is None:
        ...
        if requirements_enforced not in allowed_values:
            raise ValueError(
    ...
    def product_type_version(self):
        ...
        The version details for the Amazon product type.  # noqa: E501
    ...
    def product_type_version(self, product_type_version):
        ...
        """
        if product_type_version is None:
