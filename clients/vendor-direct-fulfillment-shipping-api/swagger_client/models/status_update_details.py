...
class StatusUpdateDetails(object):
    ...
    def __init__(self, tracking_number=None, status_code=None, reason_code=None, status_date_time=None, status_location_address=None, shipment_schedule=None):  # noqa: E501
    ...
    def status_location_address(self, status_location_address):
        ...
        :type: Address
        """
        if status_location_address is None:
