...
class Container(object):
    ...
    def __init__(self, container_type=None, container_identifier=None, tracking_number=None, manifest_id=None, manifest_date=None, ship_method=None, scac_code=None, carrier=None, container_sequence_number=None, dimensions=None, weight=None, packed_items=None):  # noqa: E501
