...
class AwdApi(object):
    ...
    def confirm_replenishment_order(self, order_id, **kwargs):  # noqa: E501
        ...
        Confirms an AWD replenishment order in ELIGIBLE state with a set of shipments containing items that are needed to be replenished to an FBA node. Order can only be confirmed in ELIGIBLE state.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.confirm_replenishment_order(order_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str order_id: ID of the replenishment order to be confirmed. (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.confirm_replenishment_order_with_http_info(order_id, **kwargs)  # noqa: E501
        else:
            (data) = self.confirm_replenishment_order_with_http_info(order_id, **kwargs)  # noqa: E501
            return data

    def confirm_replenishment_order_with_http_info(self, order_id, **kwargs):  # noqa: E501
        """confirm_replenishment_order  # noqa: E501

        Confirms an AWD replenishment order in ELIGIBLE state with a set of shipments containing items that are needed to be replenished to an FBA node. Order can only be confirmed in ELIGIBLE state.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.confirm_replenishment_order_with_http_info(order_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method confirm_replenishment_order" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'order_id' is set
        if self.api_client.client_side_validation and ('order_id' not in params or
                                                       params['order_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `order_id` when calling `confirm_replenishment_order`")  # noqa: E501
    ...
    def create_replenishment_order(self, body, **kwargs):  # noqa: E501
        """create_replenishment_order  # noqa: E501

        Creates an AWD replenishment order with given products to replenish. The API will return the order ID of the newly created order and also start an async validation check on the products to e. The order status will transition to ELIGIBLE/INELIGIBLE status from VALIDATING post validation check  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_replenishment_order(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param ReplenishmentOrderCreationData body: Payload for creating a replenishment order. (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.create_replenishment_order_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.create_replenishment_order_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def create_replenishment_order_with_http_info(self, body, **kwargs):  # noqa: E501
        """create_replenishment_order  # noqa: E501

        Creates an AWD replenishment order with given products to replenish. The API will return the order ID of the newly created order and also start an async validation check on the products to e. The order status will transition to ELIGIBLE/INELIGIBLE status from VALIDATING post validation check  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_replenishment_order_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_replenishment_order" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if self.api_client.client_side_validation and ('body' not in params or
                                                       params['body'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body` when calling `create_replenishment_order`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ReplenishmentOrderReference',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_replenishment_order(self, order_id, **kwargs):  # noqa: E501
        ...
        Retrieves an AWD Replenishment order with a set of shipments containing items that is/was planned to be replenished into an FBA node.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_replenishment_order(order_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str order_id: ID of the replenishment order to be retrieved. (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_replenishment_order_with_http_info(order_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_replenishment_order_with_http_info(order_id, **kwargs)  # noqa: E501
            return data

    def get_replenishment_order_with_http_info(self, order_id, **kwargs):  # noqa: E501
        """get_replenishment_order  # noqa: E501

        Retrieves an AWD Replenishment order with a set of shipments containing items that is/was planned to be replenished into an FBA node.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_replenishment_order_with_http_info(order_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_replenishment_order" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'order_id' is set
        if self.api_client.client_side_validation and ('order_id' not in params or
                                                       params['order_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `order_id` when calling `get_replenishment_order`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ReplenishmentOrder',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def list_replenishment_orders(self, **kwargs):  # noqa: E501
        """list_replenishment_orders  # noqa: E501

        Retrieves all the AWD replenishment orders pertaining to a merchant with optional filters. API by default will sort orders by updatedAt attribute in descending order.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_replenishment_orders(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param datetime updated_after: Get the replenishment orders updated after certain time (Inclusive) Date should be in ISO 8601 format as defined by date-time in - https://www.rfc-editor.org/rfc/rfc3339.
        :param datetime updated_before: Get the replenishment orders updated before certain time (Inclusive) Date should be in ISO 8601 format as defined by date-time in - https://www.rfc-editor.org/rfc/rfc3339.
        :param str sort_order: Sort the response in ASCENDING or DESCENDING order. The default sort order is DESCENDING.
        :param int max_results: Maximum results to be returned in a single response.
        :param str next_token: A token that is used to retrieve the next page of results. The response includes `nextToken` when the number of results exceeds the specified `maxResults` value. To get the next page of results, call the operation with this token and include the same arguments as the call that produced the token. To get a complete list, call this operation until `nextToken` is null. Note that this operation can return empty pages.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_replenishment_orders_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.list_replenishment_orders_with_http_info(**kwargs)  # noqa: E501
            return data

    def list_replenishment_orders_with_http_info(self, **kwargs):  # noqa: E501
        """list_replenishment_orders  # noqa: E501

        Retrieves all the AWD replenishment orders pertaining to a merchant with optional filters. API by default will sort orders by updatedAt attribute in descending order.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_replenishment_orders_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_replenishment_orders" % key
                )
            params[key] = val
        del params['kwargs']

        if self.api_client.client_side_validation and ('max_results' in params and params['max_results'] > 100):  # noqa: E501
            raise ValueError("Invalid value for parameter `max_results` when calling `list_replenishment_orders`, must be a value less than or equal to `100`")  # noqa: E501
        if self.api_client.client_side_validation and ('max_results' in params and params['max_results'] < 1):  # noqa: E501
            raise ValueError("Invalid value for parameter `max_results` when calling `list_replenishment_orders`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ReplenishmentOrderListing',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
