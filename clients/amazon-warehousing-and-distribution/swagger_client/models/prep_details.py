...
class PrepDetails(object):
    ...
    def __init__(self, label_owner=None, prep_category=None, prep_instructions=None, prep_owner=None):  # noqa: E501
    ...
    def prep_category(self):
        ...
        The preparation category for shipping an item to Amazon's fulfillment network.  # noqa: E501
