# swagger_client.VendorInvoiceApi
...
api_instance = swagger_client.VendorInvoiceApi()
body = swagger_client.SubmitInvoiceRequest() # SubmitInvoiceRequest | The request body containing one or more invoices for vendor orders.
