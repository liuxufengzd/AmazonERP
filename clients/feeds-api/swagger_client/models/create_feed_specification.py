...
class CreateFeedSpecification(object):
    ...
    def input_feed_document_id(self):
        ...
        The document identifier returned by the createFeedDocument operation. Upload the feed document contents before calling the createFeed operation.  # noqa: E501
