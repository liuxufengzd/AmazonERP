...
class ListOfferMetricsResponseOffer(object):
    ...
    def fulfillment_channel_type(self):
        ...
        The fulfillment channel type of an offer. This property is only supported for sellers and not for vendors.  # noqa: E501
    ...
    def next30_day_total_subscriptions_revenue(self, next30_day_total_subscriptions_revenue):
        ...
        :type: float
        """
        if next30_day_total_subscriptions_revenue is not None and next30_day_total_subscriptions_revenue < 0:  # noqa: E501
    ...
    def next60_day_total_subscriptions_revenue(self, next60_day_total_subscriptions_revenue):
        ...
        :type: float
        """
        if next60_day_total_subscriptions_revenue is not None and next60_day_total_subscriptions_revenue < 0:  # noqa: E501
    ...
    def next90_day_total_subscriptions_revenue(self, next90_day_total_subscriptions_revenue):
        ...
        :type: float
        """
        if next90_day_total_subscriptions_revenue is not None and next90_day_total_subscriptions_revenue < 0:  # noqa: E501
    ...
    def next30_day_shipped_subscription_units(self, next30_day_shipped_subscription_units):
        ...
        :type: float
        """
        if next30_day_shipped_subscription_units is not None and next30_day_shipped_subscription_units < 0:  # noqa: E501
    ...
    def next60_day_shipped_subscription_units(self, next60_day_shipped_subscription_units):
        ...
        :type: float
        """
        if next60_day_shipped_subscription_units is not None and next60_day_shipped_subscription_units < 0:  # noqa: E501
    ...
    def next90_day_shipped_subscription_units(self, next90_day_shipped_subscription_units):
        ...
        :type: float
        """
        if next90_day_shipped_subscription_units is not None and next90_day_shipped_subscription_units < 0:  # noqa: E501
