...
class RelatedIdentifier(object):
    ...
    def __init__(self, related_identifier_name=None, related_identifier_value=None):  # noqa: E501
    ...
    def related_identifier_name(self):
        ...
        An enumerated set of related business identifier names.  # noqa: E501
    ...
    def related_identifier_name(self, related_identifier_name):
        ...
        if related_identifier_name not in allowed_values:
            raise ValueError(
