...
class ItemRelatedIdentifier(object):
    ...
    def __init__(self, item_related_identifier_name=None, item_related_identifier_value=None):  # noqa: E501
    ...
    def item_related_identifier_name(self, item_related_identifier_name):
        ...
        if item_related_identifier_name not in allowed_values:
            raise ValueError(
    ...
    def item_related_identifier_value(self):
        ...
        Corresponding value to `ItemRelatedIdentifierName`.  # noqa: E501
