...
class MarketplaceDetails(object):
    ...
    def __init__(self, marketplace_id=None, marketplace_name=None):  # noqa: E501
    ...
    def marketplace_name(self):
        ...
        The name of the marketplace where the transaction occurred. For example: `Amazon.com`,`Amazon.in`  # noqa: E501
