...
class Buyer(object):
    ...
    def __init__(self, buyer_id=None, name=None, phone=None, is_prime_member=None):  # noqa: E501
    ...
    def buyer_id(self, buyer_id):
        ...
        :type: str
        """
        if buyer_id is not None and not re.search(r'^[A-Z0-9]*$', buyer_id):  # noqa: E501
