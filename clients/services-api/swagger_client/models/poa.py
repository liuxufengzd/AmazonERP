...
class Poa(object):
    ...
    def __init__(self, appointment_time=None, technicians=None, uploading_technician=None, upload_time=None, poa_type=None):  # noqa: E501
    ...
    def uploading_technician(self, uploading_technician):
        ...
        :type: str
        """
        if uploading_technician is not None and not re.search(r'^[A-Z0-9]*$', uploading_technician):  # noqa: E501
    ...
    def poa_type(self, poa_type):
        ...
        if poa_type not in allowed_values:
            raise ValueError(
