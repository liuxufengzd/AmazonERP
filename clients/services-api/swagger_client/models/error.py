...
class Error(object):
    ...
    def __init__(self, code=None, message=None, details=None, error_level=None):  # noqa: E501
    ...
    def error_level(self):
        """Gets the error_level of this Error.  # noqa: E501

        The type of error.  # noqa: E501

        :return: The error_level of this Error.  # noqa: E501
        :rtype: str
        """
    ...
    def error_level(self, error_level):
        """Sets the error_level of this Error.

        The type of error.  # noqa: E501

        :param error_level: The error_level of this Error.  # noqa: E501
        :type: str
        """
        allowed_values = ["ERROR", "WARNING"]  # noqa: E501
        if error_level not in allowed_values:
            raise ValueError(
                "Invalid value for `error_level` ({0}), must be one of {1}"  # noqa: E501
                .format(error_level, allowed_values)
            )
