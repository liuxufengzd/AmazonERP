...
class Technician(object):
    ...
    def __init__(self, technician_id=None, name=None):  # noqa: E501
    ...
    def technician_id(self, technician_id):
        ...
        :type: str
        """
        if technician_id is not None and len(technician_id) > 50:
            raise ValueError("Invalid value for `technician_id`, length must be less than or equal to `50`")  # noqa: E501
        if technician_id is not None and len(technician_id) < 1:
