...
class ServiceUploadDocument(object):
    ...
    def __init__(self, content_type=None, content_length=None, content_md5=None):  # noqa: E501
    ...
    def content_length(self, content_length):
        ...
        if content_length is not None and content_length > 5242880:  # noqa: E501
            raise ValueError("Invalid value for `content_length`, must be a value less than or equal to `5242880`")  # noqa: E501
        if content_length is not None and content_length < 1:  # noqa: E501
    ...
    def content_md5(self, content_md5):
        ...
        :type: str
        """
        if content_md5 is not None and not re.search(r'^[A-Za-z0-9\\\\+\/]{22}={2}$', content_md5):  # noqa: E501
