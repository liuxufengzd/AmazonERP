...
class ServiceLocation(object):
    ...
    def __init__(self, service_location_type=None, address=None):  # noqa: E501
    ...
    def service_location_type(self, service_location_type):
        ...
        if service_location_type not in allowed_values:
            raise ValueError(
    ...
    def address(self):
        ...
        The shipping address for the service job.  # noqa: E501
