...
class ServiceJobProvider(object):
    ...
    def __init__(self, service_job_provider_id=None):  # noqa: E501
    ...
    def service_job_provider_id(self, service_job_provider_id):
        ...
        :type: str
        """
        if service_job_provider_id is not None and not re.search(r'^[A-Z0-9]*$', service_job_provider_id):  # noqa: E501
