...
class ShippingOfferingFilter(object):
    ...
    def __init__(self, include_packing_slip_with_label=None, include_complex_shipping_options=None, carrier_will_pick_up=None, delivery_experience=None):  # noqa: E501
