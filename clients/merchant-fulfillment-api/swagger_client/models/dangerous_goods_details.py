...
class DangerousGoodsDetails(object):
    ...
    def united_nations_regulatory_id(self, united_nations_regulatory_id):
        ...
        :type: str
        """
        if united_nations_regulatory_id is not None and not re.search(r'^(UN|ID|NA)[0-9]{4}$', united_nations_regulatory_id):  # noqa: E501
    ...
    def transportation_regulatory_class(self, transportation_regulatory_class):
        ...
        :type: str
        """
        if transportation_regulatory_class is not None and not re.search(r'^[1-9](\\.[1-9])?$', transportation_regulatory_class):  # noqa: E501
