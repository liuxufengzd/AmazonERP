...
class AdditionalSellerInput(object):
    ...
    def __init__(self, data_type=None, value_as_string=None, value_as_boolean=None, value_as_integer=None, value_as_timestamp=None, value_as_address=None, value_as_weight=None, value_as_dimension=None, value_as_currency=None):  # noqa: E501
