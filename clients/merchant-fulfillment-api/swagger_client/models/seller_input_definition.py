...
class SellerInputDefinition(object):
    ...
    def __init__(self, is_required=None, data_type=None, constraints=None, input_display_text=None, input_target=None, stored_value=None, restricted_set_values=None):  # noqa: E501
