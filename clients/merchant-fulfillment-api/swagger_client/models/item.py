...
class Item(object):
    ...
    def __init__(self, order_item_id=None, quantity=None, item_weight=None, item_description=None, transparency_code_list=None, item_level_seller_inputs_list=None, liquid_volume=None, is_hazmat=None, dangerous_goods_details=None):  # noqa: E501
