...
class GetEligibleShipmentServicesResult(object):
    ...
    def __init__(self, shipping_service_list=None, rejected_shipping_service_list=None, temporarily_unavailable_carrier_list=None, terms_and_conditions_not_accepted_carrier_list=None):  # noqa: E501
    ...
    def shipping_service_list(self, shipping_service_list):
        ...
        """
        if shipping_service_list is None:
