...
class Address(object):
    ...
    def __init__(self, name=None, address_line1=None, address_line2=None, address_line3=None, district_or_county=None, email=None, city=None, state_or_province_code=None, postal_code=None, country_code=None, phone=None):  # noqa: E501
