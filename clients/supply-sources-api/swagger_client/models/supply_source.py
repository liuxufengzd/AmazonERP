...
class SupplySource(object):
    ...
    def __init__(self, supply_source_id=None, supply_source_code=None, alias=None, status=None, address=None, configuration=None, capabilities=None, created_at=None, updated_at=None):  # noqa: E501
