...
class ShipmentDetails(object):
    ...
    def __init__(self, is_priority_shipment=None, is_scheduled_delivery_shipment=None, is_pslip_required=None, is_gift=None, ship_method=None, shipment_dates=None, message_to_customer=None):  # noqa: E501
    ...
    def is_priority_shipment(self, is_priority_shipment):
        ...
        :type: bool
        """
        if is_priority_shipment is None:
    ...
    def message_to_customer(self, message_to_customer):
        ...
        :type: str
        """
        if message_to_customer is None:
