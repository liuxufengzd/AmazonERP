...
class TransactionsApi(object):
    ...
    def create_transaction(self, body, dest_account_digital_signature, amount_digital_signature, marketplace_id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.create_transaction(body, dest_account_digital_signature, amount_digital_signature, marketplace_id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.create_transaction_with_http_info(body, dest_account_digital_signature, amount_digital_signature, marketplace_id, **kwargs)  # noqa: E501
        else:
            (data) = self.create_transaction_with_http_info(body, dest_account_digital_signature, amount_digital_signature, marketplace_id, **kwargs)  # noqa: E501
            return data

    def create_transaction_with_http_info(self, body, dest_account_digital_signature, amount_digital_signature, marketplace_id, **kwargs):  # noqa: E501
        """Create a transaction request from Amazon Seller Wallet account to another customer-provided account  # noqa: E501

        Create a transaction request from a Seller Wallet account to another customer-provided account.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_transaction_with_http_info(body, dest_account_digital_signature, amount_digital_signature, marketplace_id, async_req=True)
        >>> result = thread.get()
