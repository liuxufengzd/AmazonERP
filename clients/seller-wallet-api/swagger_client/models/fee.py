...
class Fee(object):
    ...
    def __init__(self, fee_id=None, fee_type=None, fee_rate_value=None, fee_amount=None):  # noqa: E501
    ...
    def fee_amount(self):
        ...
        The actual value of the fee in numeric format.  # noqa: E501
