...
class TransactionInitiationRequest(object):
    ...
    def __init__(self, source_account_id=None, destination_account_id=None, destination_transaction_instrument=None, transaction_description=None, customer_payment_reference=None, payee_contact_information=None, source_amount=None, transfer_rate_details=None, request_time=None):  # noqa: E501
    ...
    def destination_transaction_instrument(self):
        ...
        Details of the destination bank account in the transaction request.  # noqa: E501
    ...
    def destination_transaction_instrument(self, destination_transaction_instrument):
        ...
        """
        if destination_transaction_instrument is None:
    ...
    def payee_contact_information(self):
        ...
        The contact information of a payee.  # noqa: E501
    ...
    def source_amount(self):
        ...
        The transaction amount in the source account's currency format. Requests that use a currency other than the source bank account currency fail.  # noqa: E501
    ...
    def transfer_rate_details(self):
        ...
        The fees and foreign exchange rates that apply to the transaction. Transfer Rate Preview is currently optional. This field is required when the third party honors the fees and rates of the Seller Wallet transaction.  # noqa: E501
