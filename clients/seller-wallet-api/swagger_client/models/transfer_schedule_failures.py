...
class TransferScheduleFailures(object):
    ...
    def __init__(self, transfer_schedule_failure_date=None, transfer_schedule_failure_reason=None):  # noqa: E501
    ...
    def transfer_schedule_failure_date(self, transfer_schedule_failure_date):
        ...
        :type: datetime
        """
        if transfer_schedule_failure_date is None:
    ...
    def transfer_schedule_failure_reason(self, transfer_schedule_failure_reason):
        ...
        :type: str
        """
        if transfer_schedule_failure_reason is None:
