...
class TransactionAccount(object):
    ...
    def __init__(self, account_id=None, bank_account_holder_name=None, bank_name=None, bank_account_number_format=None, bank_account_number_tail=None, bank_account_country_code=None, bank_account_currency=None):  # noqa: E501
    ...
    def bank_account_number_format(self):
        ...
        The format for the bank account number.  # noqa: E501
    ...
    def bank_account_number_format(self, bank_account_number_format):
        ...
        """
        if bank_account_number_format is None:
    ...
    def bank_account_currency(self, bank_account_currency):
        ...
        :type: str
        """
        if bank_account_currency is None:
