...
class AddressInput(object):
    ...
    def __init__(self, address_line1=None, address_line2=None, city=None, company_name=None, country_code=None, district_or_county=None, email=None, name=None, phone_number=None, postal_code=None, state_or_province_code=None):  # noqa: E501
    ...
    def address_line1(self):
        """Gets the address_line1 of this AddressInput.  # noqa: E501

        Street address information.  # noqa: E501

        :return: The address_line1 of this AddressInput.  # noqa: E501
        :rtype: str
        """
    ...
    def address_line1(self, address_line1):
        """Sets the address_line1 of this AddressInput.

        Street address information.  # noqa: E501

        :param address_line1: The address_line1 of this AddressInput.  # noqa: E501
        :type: str
        """
        if address_line1 is None:
            raise ValueError("Invalid value for `address_line1`, must not be `None`")  # noqa: E501
        if address_line1 is not None and len(address_line1) > 180:
    ...
    def address_line2(self):
        """Gets the address_line2 of this AddressInput.  # noqa: E501

        Additional street address information.  # noqa: E501

        :return: The address_line2 of this AddressInput.  # noqa: E501
        :rtype: str
        """
    ...
    def address_line2(self, address_line2):
        """Sets the address_line2 of this AddressInput.

        Additional street address information.  # noqa: E501

        :param address_line2: The address_line2 of this AddressInput.  # noqa: E501
        :type: str
        """
        if address_line2 is not None and len(address_line2) > 60:
    ...
    @property
    def city(self):
        """Gets the city of this AddressInput.  # noqa: E501

        The city.  # noqa: E501

        :return: The city of this AddressInput.  # noqa: E501
        :rtype: str
        """
        return self._city
    ...
    @city.setter
    def city(self, city):
        """Sets the city of this AddressInput.

        The city.  # noqa: E501

        :param city: The city of this AddressInput.  # noqa: E501
        :type: str
        """
        if city is None:
    ...
    def company_name(self):
        """Gets the company_name of this AddressInput.  # noqa: E501

        The name of the business.  # noqa: E501

        :return: The company_name of this AddressInput.  # noqa: E501
        :rtype: str
        """
    ...
    def company_name(self, company_name):
        """Sets the company_name of this AddressInput.

        The name of the business.  # noqa: E501

        :param company_name: The company_name of this AddressInput.  # noqa: E501
        :type: str
        """
    ...
    def country_code(self):
        """Gets the country_code of this AddressInput.  # noqa: E501

        The country code in two-character ISO 3166-1 alpha-2 format.  # noqa: E501

        :return: The country_code of this AddressInput.  # noqa: E501
        :rtype: str
        """
    ...
    def country_code(self, country_code):
        """Sets the country_code of this AddressInput.

        The country code in two-character ISO 3166-1 alpha-2 format.  # noqa: E501

        :param country_code: The country_code of this AddressInput.  # noqa: E501
        :type: str
        """
    ...
    def district_or_county(self):
        """Gets the district_or_county of this AddressInput.  # noqa: E501

        The district or county.  # noqa: E501

        :return: The district_or_county of this AddressInput.  # noqa: E501
        :rtype: str
        """
    ...
    def district_or_county(self, district_or_county):
        """Sets the district_or_county of this AddressInput.

        The district or county.  # noqa: E501

        :param district_or_county: The district_or_county of this AddressInput.  # noqa: E501
        :type: str
        """
        if district_or_county is not None and len(district_or_county) > 50:
            raise ValueError("Invalid value for `district_or_county`, length must be less than or equal to `50`")  # noqa: E501
        if district_or_county is not None and len(district_or_county) < 1:
    ...
    @property
    def email(self):
        """Gets the email of this AddressInput.  # noqa: E501

        The email address.  # noqa: E501

        :return: The email of this AddressInput.  # noqa: E501
        :rtype: str
        """
        return self._email
    ...
    def email(self, email):
        """Sets the email of this AddressInput.

        The email address.  # noqa: E501

        :param email: The email of this AddressInput.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this AddressInput.  # noqa: E501

        The name of the individual who is the primary contact.  # noqa: E501

        :return: The name of this AddressInput.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this AddressInput.

        The name of the individual who is the primary contact.  # noqa: E501

        :param name: The name of this AddressInput.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def phone_number(self):
        """Gets the phone_number of this AddressInput.  # noqa: E501

        The phone number.  # noqa: E501

        :return: The phone_number of this AddressInput.  # noqa: E501
        :rtype: str
        """
    ...
    def phone_number(self, phone_number):
        """Sets the phone_number of this AddressInput.

        The phone number.  # noqa: E501

        :param phone_number: The phone_number of this AddressInput.  # noqa: E501
        :type: str
        """
    ...
    def postal_code(self, postal_code):
        ...
        if postal_code is not None and len(postal_code) > 32:
    ...
    def state_or_province_code(self):
        """Gets the state_or_province_code of this AddressInput.  # noqa: E501

        The state or province code.  # noqa: E501

        :return: The state_or_province_code of this AddressInput.  # noqa: E501
        :rtype: str
        """
    ...
    def state_or_province_code(self, state_or_province_code):
        """Sets the state_or_province_code of this AddressInput.

        The state or province code.  # noqa: E501

        :param state_or_province_code: The state_or_province_code of this AddressInput.  # noqa: E501
        :type: str
        """
        if state_or_province_code is not None and len(state_or_province_code) > 64:
            raise ValueError("Invalid value for `state_or_province_code`, length must be less than or equal to `64`")  # noqa: E501
        if state_or_province_code is not None and len(state_or_province_code) < 1:
