...
class Item(object):
    ...
    def __init__(self, asin=None, expiration=None, fnsku=None, label_owner=None, manufacturing_lot_code=None, msku=None, prep_instructions=None, quantity=None):  # noqa: E501
    ...
    def label_owner(self, label_owner):
        ...
        if label_owner is not None and len(label_owner) > 1024:
            raise ValueError("Invalid value for `label_owner`, length must be less than or equal to `1024`")  # noqa: E501
        if label_owner is not None and len(label_owner) < 1:
    ...
    def msku(self, msku):
        ...
        if msku is not None and len(msku) > 255:
    ...
    def quantity(self, quantity):
        ...
        if quantity is not None and quantity > 500000:  # noqa: E501
