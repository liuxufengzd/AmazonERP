...
class PackageGroupingInput(object):
    ...
    def __init__(self, boxes=None, packing_group_id=None, shipment_id=None):  # noqa: E501
    ...
    def packing_group_id(self, packing_group_id):
        ...
        :type: str
        """
        if packing_group_id is not None and len(packing_group_id) > 38:
        ...
        if packing_group_id is not None and not re.search(r'^[a-zA-Z0-9-]*$', packing_group_id):  # noqa: E501
