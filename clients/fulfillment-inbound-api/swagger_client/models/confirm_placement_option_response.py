...
class ConfirmPlacementOptionResponse(object):
    ...
    def __init__(self, operation_id=None):  # noqa: E501
        """ConfirmPlacementOptionResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def operation_id(self):
        """Gets the operation_id of this ConfirmPlacementOptionResponse.  # noqa: E501

        UUID for the given operation.  # noqa: E501

        :return: The operation_id of this ConfirmPlacementOptionResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def operation_id(self, operation_id):
        """Sets the operation_id of this ConfirmPlacementOptionResponse.

        UUID for the given operation.  # noqa: E501

        :param operation_id: The operation_id of this ConfirmPlacementOptionResponse.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ConfirmPlacementOptionResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConfirmPlacementOptionResponse):
            return False
