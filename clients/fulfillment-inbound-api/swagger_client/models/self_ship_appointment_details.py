...
class SelfShipAppointmentDetails(object):
    ...
    def __init__(self, appointment_id=None, appointment_slot_time=None, appointment_status=None):  # noqa: E501
    ...
    def appointment_status(self, appointment_status):
        ...
        :type: str
        """
        if appointment_status is not None and len(appointment_status) > 1024:
            raise ValueError("Invalid value for `appointment_status`, length must be less than or equal to `1024`")  # noqa: E501
        if appointment_status is not None and len(appointment_status) < 1:
