...
class Box(object):
    ...
    def __init__(self, box_id=None, content_information_source=None, destination_region=None, dimensions=None, external_container_identifier=None, external_container_identifier_type=None, items=None, package_id=None, quantity=None, template_name=None, weight=None):  # noqa: E501
    ...
    def external_container_identifier(self, external_container_identifier):
        ...
        :type: str
        """
        if external_container_identifier is not None and len(external_container_identifier) > 1024:
            raise ValueError("Invalid value for `external_container_identifier`, length must be less than or equal to `1024`")  # noqa: E501
        if external_container_identifier is not None and len(external_container_identifier) < 1:
    ...
    def external_container_identifier_type(self, external_container_identifier_type):
        ...
        :type: str
        """
        if external_container_identifier_type is not None and len(external_container_identifier_type) > 1024:
        ...
        if external_container_identifier_type is not None and len(external_container_identifier_type) < 1:
    ...
    def package_id(self, package_id):
        ...
        if package_id is not None and len(package_id) > 38:
        ...
        if package_id is not None and not re.search(r'^[a-zA-Z0-9-]*$', package_id):  # noqa: E501
    ...
    def template_name(self, template_name):
        ...
        :type: str
        """
        if template_name is not None and len(template_name) > 1024:
