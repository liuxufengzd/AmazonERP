...
class Dimensions(object):
    ...
    def __init__(self, height=None, length=None, unit_of_measurement=None, width=None):  # noqa: E501
    ...
    def height(self, height):
        ...
        if height is not None and height > 100000:  # noqa: E501
            raise ValueError("Invalid value for `height`, must be a value less than or equal to `100000`")  # noqa: E501
    ...
    def length(self, length):
        ...
        if length is not None and length > 100000:  # noqa: E501
            raise ValueError("Invalid value for `length`, must be a value less than or equal to `100000`")  # noqa: E501
    ...
    def width(self, width):
        ...
        if width is not None and width > 100000:  # noqa: E501
            raise ValueError("Invalid value for `width`, must be a value less than or equal to `100000`")  # noqa: E501
