...
class MskuPrepDetail(object):
    ...
    def __init__(self, all_owners_constraint=None, label_owner_constraint=None, msku=None, prep_category=None, prep_owner_constraint=None, prep_types=None):  # noqa: E501
