...
class CreateMarketplaceItemLabelsRequest(object):
    ...
    def __init__(self, height=None, label_type=None, locale_code='en_US', marketplace_id=None, msku_quantities=None, page_type=None, width=None):  # noqa: E501
    ...
    def height(self, height):
        ...
        :type: float
        """
        if height is not None and height > 100:  # noqa: E501
            raise ValueError("Invalid value for `height`, must be a value less than or equal to `100`")  # noqa: E501
        if height is not None and height < 25:  # noqa: E501
    ...
    def locale_code(self, locale_code):
        ...
        :type: str
        """
        if locale_code is not None and not re.search(r'^[a-z]{2}_[A-Z]{2}$', locale_code):  # noqa: E501
    ...
    def marketplace_id(self, marketplace_id):
        ...
        if marketplace_id is not None and len(marketplace_id) > 20:
            raise ValueError("Invalid value for `marketplace_id`, length must be less than or equal to `20`")  # noqa: E501
        if marketplace_id is not None and len(marketplace_id) < 1:
    ...
    def width(self, width):
        ...
        :type: float
        """
        if width is not None and width > 100:  # noqa: E501
            raise ValueError("Invalid value for `width`, must be a value less than or equal to `100`")  # noqa: E501
        if width is not None and width < 25:  # noqa: E501
