...
class TransportationOption(object):
    ...
    def __init__(self, carrier=None, carrier_appointment=None, preconditions=None, quote=None, shipment_id=None, shipping_mode=None, shipping_solution=None, transportation_option_id=None):  # noqa: E501
