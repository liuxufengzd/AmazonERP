...
class ShipmentDestination(object):
    ...
    def __init__(self, address=None, destination_type=None, warehouse_id=None):  # noqa: E501
    ...
    def address(self):
        ...
        The address the shipment should be sent to. This can be empty if the destination type is `AMAZON_OPTIMIZED`.  # noqa: E501
    ...
    def destination_type(self, destination_type):
        ...
        if destination_type is not None and len(destination_type) > 1024:
            raise ValueError("Invalid value for `destination_type`, length must be less than or equal to `1024`")  # noqa: E501
        if destination_type is not None and len(destination_type) < 1:
