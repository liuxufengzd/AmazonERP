...
class ContentUpdatePreview(object):
    ...
    def __init__(self, content_update_preview_id=None, expiration=None, requested_updates=None, transportation_option=None):  # noqa: E501
    ...
    def content_update_preview_id(self, content_update_preview_id):
        ...
        :type: str
        """
        if content_update_preview_id is None:
            raise ValueError("Invalid value for `content_update_preview_id`, must not be `None`")  # noqa: E501
        if content_update_preview_id is not None and len(content_update_preview_id) > 38:
        ...
        if content_update_preview_id is not None and not re.search(r'^[a-zA-Z0-9-]*$', content_update_preview_id):  # noqa: E501
    ...
    def transportation_option(self, transportation_option):
        ...
        """
        if transportation_option is None:
