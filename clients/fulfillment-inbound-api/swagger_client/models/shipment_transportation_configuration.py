...
class ShipmentTransportationConfiguration(object):
    ...
    def __init__(self, contact_information=None, freight_information=None, pallets=None, ready_to_ship_window=None, shipment_id=None):  # noqa: E501
    ...
    def ready_to_ship_window(self):
        ...
        The range of dates within which the seller intends to ship their items. This is the pick-up date or 'ready to ship' date, not an estimated delivery date.  # noqa: E501
    ...
    def ready_to_ship_window(self, ready_to_ship_window):
        ...
        :type: WindowInput
        """
        if ready_to_ship_window is None:
