...
class Account(object):
    ...
    def __init__(self, marketplace_participation_list=None, business_type=None, selling_plan=None, business=None, primary_contact=None):  # noqa: E501
    ...
    def marketplace_participation_list(self, marketplace_participation_list):
        ...
        """
        if marketplace_participation_list is None:
    ...
    def selling_plan(self, selling_plan):
        ...
        if selling_plan not in allowed_values:
            raise ValueError(
