...
class ImageComponent(object):
    ...
    def __init__(self, upload_destination_id=None, image_crop_specification=None, alt_text=None):  # noqa: E501
    ...
    def upload_destination_id(self, upload_destination_id):
        ...
        if upload_destination_id is not None and len(upload_destination_id) < 1:
    ...
    def image_crop_specification(self, image_crop_specification):
        ...
        """
        if image_crop_specification is None:
    ...
    def alt_text(self, alt_text):
        ...
        if alt_text is not None and len(alt_text) < 1:
