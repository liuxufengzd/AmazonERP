...
class StandardImageSidebarModule(object):
    ...
    def __init__(self, headline=None, image_caption_block=None, description_text_block=None, description_list_block=None, sidebar_image_text_block=None, sidebar_list_block=None):  # noqa: E501
