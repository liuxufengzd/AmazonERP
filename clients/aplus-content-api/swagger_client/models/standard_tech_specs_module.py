...
class StandardTechSpecsModule(object):
    ...
    def __init__(self, headline=None, specification_list=None, table_count=None):  # noqa: E501
    ...
    def table_count(self, table_count):
        ...
        :type: int
        """
        if table_count is not None and table_count > 2:  # noqa: E501
            raise ValueError("Invalid value for `table_count`, must be a value less than or equal to `2`")  # noqa: E501
        if table_count is not None and table_count < 1:  # noqa: E501
