...
class ContentModule(object):
    ...
    def __init__(self, content_module_type=None, standard_company_logo=None, standard_comparison_table=None, standard_four_image_text=None, standard_four_image_text_quadrant=None, standard_header_image_text=None, standard_image_sidebar=None, standard_image_text_overlay=None, standard_multiple_image_text=None, standard_product_description=None, standard_single_image_highlights=None, standard_single_image_specs_detail=None, standard_single_side_image=None, standard_tech_specs=None, standard_text=None, standard_three_image_text=None):  # noqa: E501
    ...
    def content_module_type(self, content_module_type):
        ...
        """
        if content_module_type is None:
