...
class VendorShippingApi(object):
    ...
    def get_shipment_details(self, **kwargs):  # noqa: E501
        ...
        :param datetime estimated_delivery_after: Get Shipment Details by passing Estimated Delivery Date After. Must be in <a href='https://developer-docs.amazon.com/sp-api/docs/iso-8601'>ISO 8601</a> format.
