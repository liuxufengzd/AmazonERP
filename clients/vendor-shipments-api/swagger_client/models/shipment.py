...
class Shipment(object):
    ...
    def vendor_shipment_identifier(self, vendor_shipment_identifier):
        ...
        :type: str
        """
        if vendor_shipment_identifier is None:
    ...
    def current_shipment_status(self, current_shipment_status):
        ...
        if current_shipment_status not in allowed_values:
            raise ValueError(
    ...
    def shipment_freight_term(self, shipment_freight_term):
        ...
        if shipment_freight_term not in allowed_values:
            raise ValueError(
    ...
    def ship_from_party(self):
        ...
        Name/Address and tax details of the ship from party.  # noqa: E501
    ...
    def ship_to_party(self):
        ...
        Name/Address of the destination warehouse where the shipment is being shipped to.  # noqa: E501
    ...
    def shipment_measurements(self):
        ...
        Indicates the shipment measurement details on how many cartons and pallets and the total transportation weight and volume as part of this request. This is a mandatory detail which will help determining the transportation cost, truck allocations and route determination efficiently.  # noqa: E501
    ...
    def collect_freight_pickup_details(self):
        ...
        Indicates the earliest pickup date for the transportation from vendor warehouse. This information is mandatory to be filled for requesting transportation from Buyer (WePay/Collect).  # noqa: E501
    ...
    def import_details(self):
        ...
        Provide these fields only if this shipment is a direct import.  # noqa: E501
    ...
    def transportation_details(self):
        ...
        Transportation details this a mandatory information which states delivery date, shipping date and carrier details.  # noqa: E501
