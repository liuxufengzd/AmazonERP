...
class Containers(object):
    ...
    def __init__(self, container_type=None, container_sequence_number=None, container_identifiers=None, tracking_number=None, dimensions=None, weight=None, tier=None, block=None, inner_containers_details=None, packed_items=None):  # noqa: E501
    ...
    def container_identifiers(self, container_identifiers):
        ...
        """
        if container_identifiers is None:
