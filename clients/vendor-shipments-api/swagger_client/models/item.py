...
class Item(object):
    ...
    def __init__(self, item_sequence_number=None, amazon_product_identifier=None, vendor_product_identifier=None, shipped_quantity=None, item_details=None):  # noqa: E501
