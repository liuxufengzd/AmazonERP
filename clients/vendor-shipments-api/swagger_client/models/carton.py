...
class Carton(object):
    ...
    def __init__(self, carton_identifiers=None, carton_sequence_number=None, dimensions=None, weight=None, tracking_number=None, items=None):  # noqa: E501
    ...
    def carton_sequence_number(self, carton_sequence_number):
        ...
        :type: str
        """
        if carton_sequence_number is None:
