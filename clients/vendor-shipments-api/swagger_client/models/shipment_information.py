...
class ShipmentInformation(object):
    ...
    def __init__(self, vendor_details=None, buyer_reference_number=None, ship_to_party=None, ship_from_party=None, warehouse_id=None, master_tracking_id=None, total_label_count=None, ship_mode=None):  # noqa: E501
    ...
    def vendor_details(self):
        ...
        Vendor Details requesting for Shipment Label  # noqa: E501
    ...
    def ship_to_party(self):
        ...
        The name and address of the destination warehouse where the shipment is being shipped.  # noqa: E501
    ...
    def ship_mode(self, ship_mode):
        ...
        if ship_mode not in allowed_values:
            raise ValueError(
