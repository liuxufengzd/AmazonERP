...
class ImportDetails(object):
    ...
    def __init__(self, method_of_payment=None, seal_number=None, route=None, import_containers=None, billable_weight=None, estimated_ship_by_date=None, handling_instructions=None):  # noqa: E501
    ...
    def method_of_payment(self, method_of_payment):
        ...
        if method_of_payment not in allowed_values:
            raise ValueError(
    ...
    def route(self):
        ...
        The route and stop details for this shipment.  # noqa: E501
    ...
    def import_containers(self, import_containers):
        ...
        :type: str
        """
        if import_containers is not None and len(import_containers) > 64:
    ...
    def billable_weight(self):
        ...
        Billable weight of the direct imports shipment.  # noqa: E501
    ...
    def handling_instructions(self, handling_instructions):
        ...
        if handling_instructions not in allowed_values:
            raise ValueError(
