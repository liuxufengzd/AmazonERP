...
class Stop(object):
    ...
    def __init__(self, function_code=None, location_identification=None, arrival_time=None, departure_time=None):  # noqa: E501
    ...
    def function_code(self, function_code):
        ...
        if function_code not in allowed_values:
            raise ValueError(
