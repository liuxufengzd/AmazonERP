...
class PackedItems(object):
    ...
    def __init__(self, item_sequence_number=None, buyer_product_identifier=None, vendor_product_identifier=None, packed_quantity=None, item_details=None):  # noqa: E501
