...
class ShipmentConfirmation(object):
    ...
    def shipment_confirmation_type(self, shipment_confirmation_type):
        ...
        :type: str
        """
        if shipment_confirmation_type is None:
        ...
        if shipment_confirmation_type not in allowed_values:
            raise ValueError(
    ...
    def shipment_structure(self, shipment_structure):
        ...
        if shipment_structure not in allowed_values:
            raise ValueError(
    ...
    def transportation_details(self):
        ...
        Transportation details for this shipment.  # noqa: E501
    ...
    def shipment_confirmation_date(self, shipment_confirmation_date):
        ...
        :type: datetime
        """
        if shipment_confirmation_date is None:
