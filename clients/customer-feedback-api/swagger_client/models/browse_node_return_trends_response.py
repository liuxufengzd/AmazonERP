...
class BrowseNodeReturnTrendsResponse(object):
    ...
    def __init__(self, browse_node_id=None, display_name=None, marketplace_id=None, country_code=None, date_range=None, return_trends=None):  # noqa: E501
