...
class ItemReviewTrendPoint(object):
    ...
    def __init__(self, date_range=None, asin_metrics=None, parent_asin_metrics=None, browse_node_metrics=None):  # noqa: E501
    ...
    def date_range(self):
        ...
        The date range of the item review trend metric.  # noqa: E501
    ...
    def asin_metrics(self):
        ...
        The ASIN's review trend metrics.  # noqa: E501
    ...
    def parent_asin_metrics(self):
        ...
        The parent ASIN's review trend metrics. This value is `null` if there isn't enough topic data for the parent ASIN.  # noqa: E501
    ...
    def browse_node_metrics(self):
        ...
        The browse node's review trend metrics. This value is `null` if there isn't enough topic data for the browse node.  # noqa: E501
