...
class Item(object):
    ...
    def __init__(self, sku=None, summaries=None, attributes=None, issues=None, offers=None, fulfillment_availability=None, procurement=None, relationships=None, product_types=None):  # noqa: E501
