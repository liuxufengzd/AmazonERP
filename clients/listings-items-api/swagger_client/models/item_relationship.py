...
class ItemRelationship(object):
    ...
    def __init__(self, child_skus=None, parent_skus=None, variation_theme=None, type=None):  # noqa: E501
    ...
    def variation_theme(self):
        ...
        For `VARIATION` relationships, the variation theme is the combination of listing item attributes that define the variation family.  # noqa: E501
