...
# create an instance of the API class
api_instance = swagger_client.ProductPricingApi()
get_featured_offer_expected_price_batch_request_body = swagger_client.GetFeaturedOfferExpectedPriceBatchRequest() # GetFeaturedOfferExpectedPriceBatchRequest | The batch of `getFeaturedOfferExpectedPrice` requests.
