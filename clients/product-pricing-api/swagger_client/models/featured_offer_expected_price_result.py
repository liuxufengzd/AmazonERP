...
class FeaturedOfferExpectedPriceResult(object):
    ...
    def __init__(self, featured_offer_expected_price=None, result_status=None, competing_featured_offer=None, current_featured_offer=None):  # noqa: E501
    ...
    def competing_featured_offer(self):
        ...
        The offer that will likely be the featured offer if the target offer is priced above its FOEP. If the target offer is currently the featured offer, this property will be different than `currentFeaturedOffer`.  # noqa: E501
    ...
    def current_featured_offer(self):
        ...
        The offer that is currently the featured offer. If the target offer is not currently featured, then this property will be equal to `competingFeaturedOffer`.  # noqa: E501
