...
class Offer(object):
    ...
    def __init__(self, seller_id=None, condition=None, sub_condition=None, fulfillment_type=None, listing_price=None, shipping_options=None, points=None, prime_details=None):  # noqa: E501
