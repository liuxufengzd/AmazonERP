...
class FeaturedOfferExpectedPriceResponseBody(object):
    ...
    swagger_types = {
        ...
        'featured_offer_expected_price_results': 'FeaturedOfferExpectedPriceResultList',
        'errors': 'ErrorList'
    }
    ...
    def __init__(self, offer_identifier=None, featured_offer_expected_price_results=None, errors=None):  # noqa: E501
    ...
    def offer_identifier(self):
        ...
        Metadata that identifies the target offer for which the FOEP result data was computed.  # noqa: E501
    ...
    def errors(self):
        ...
        The errors that occurred if the operation wasn't successful (HTTP status code non-200).  # noqa: E501
