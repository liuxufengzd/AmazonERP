...
class FeaturedOfferSegment(object):
    ...
    def __init__(self, customer_membership=None, segment_details=None):  # noqa: E501
    ...
    def customer_membership(self, customer_membership):
        ...
        if customer_membership not in allowed_values:
            raise ValueError(
    ...
    def segment_details(self):
        ...
        The details about the segment.  # noqa: E501
